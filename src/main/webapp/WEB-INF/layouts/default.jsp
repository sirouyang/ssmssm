...
<!-- jQuery UI 1.11.4 -->
<script src="${ctx}/res/AdminLTE/plugins/jQueryUI/jquery-ui.min.js"></script>
...
<!-- Morris.js charts -->
<!-- <script
	src="${ctx}/res/AdminLTE/raphael-2.1.0/raphael-min.js"></script>
<script src="${ctx}/res/AdminLTE/plugins/morris/morris.min.js"></script> -->
<!-- Sparkline -->
<script
	src="${ctx}/res/AdminLTE/plugins/sparkline/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script
	src="${ctx}/res/AdminLTE/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script
	src="${ctx}/res/AdminLTE/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="${ctx}/res/AdminLTE/plugins/knob/jquery.knob.js"></script>
<!-- daterangepicker -->
<script
	src="${ctx}/res/AdminLTE/moment.js-2.10.2/moment.min.js"></script>
<script
	src="${ctx}/res/AdminLTE/plugins/daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script
	src="${ctx}/res/AdminLTE/plugins/datepicker/bootstrap-datepicker.js"></script>
<!-- Bootstrap WYSIHTML5 -->
<script
	src="${ctx}/res/AdminLTE/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- DataTables -->
<script
...
<!-- FastClick -->
<script src="${ctx}/res/AdminLTE/plugins/fastclick/fastclick.js"></script>
<!-- AdminLTE App -->
...
<!-- DataTables -->
<link rel="stylesheet"
	href="${ctx}/res/AdminLTE/plugins/datatables/dataTables.bootstrap.css">
<!-- Theme style -->
<link rel="stylesheet"
...
<link rel="stylesheet"
	href="${ctx}/res/AdminLTE/dist/css/skins/_all-skins.min.css">
<!-- iCheck -->
<link rel="stylesheet"
	href="${ctx}/res/AdminLTE/plugins/iCheck/flat/blue.css">
<!-- Morris chart -->
<!-- <link rel="stylesheet"
	href="${ctx}/res/AdminLTE/plugins/morris/morris.css"> -->
<!-- jvectormap -->
<link rel="stylesheet"
	href="${ctx}/res/AdminLTE/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
<!-- Date Picker -->
<link rel="stylesheet"
	href="${ctx}/res/AdminLTE/plugins/datepicker/datepicker3.css">
<!-- Daterange picker -->
<link rel="stylesheet"
	href="${ctx}/res/AdminLTE/plugins/daterangepicker/daterangepicker-bs3.css">
<!-- bootstrap wysihtml5 - text editor -->
<link rel="stylesheet"
	href="${ctx}/res/AdminLTE/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
...
<body style="overflow: auto;"
	...
	<sitemesh:getProperty property="body.class" writeEntireProperty="true"/>
					...
					<ul class="nav navbar-nav">
									...
									<ul class="menu">
										<li>
											<!-- start message --> <a href="#">
												<div class="pull-left">
													<img src="${ctx}/res/AdminLTE/dist/img/user2-160x160.jpg"
										...
										<li><a href="#">
												<div class="pull-left">
													<img src="${ctx}/res/AdminLTE/dist/img/user3-128x128.jpg"
														class="img-circle" alt="User Image">
												</div>
												<h4>
										...
										<li><a href="#">
												<div class="pull-left">
													<img src="${ctx}/res/AdminLTE/dist/img/user4-128x128.jpg"
														class="img-circle" alt="User Image">
												</div>
												<h4>
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="${ctx}/res/AdminLTE/dist/img/user2-160x160.jpg"
				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li class="active"><a href="${ctx}/user/index"><i
