...
/**
 * @Description: Myibatis对应的PostgreSQL分页插件
 * @author XULEI
 * @date 2014年11月5日 下午5:48:40
 * 
 */
public class PostgreSQLPaginationPlugin extends PluginAdapter {
	...
	public boolean sqlMapDocumentGenerated(Document document,
		...
		paginationSuffixElement.addAttribute(new Attribute("id",
				"PostgreSQLDialectSuffix"));
		XmlElement pageEnd = new XmlElement("if");
		pageEnd.addAttribute(new Attribute("test", "page != null"));
		pageEnd.addElement(new TextElement(
				"<![CDATA[ ) as pagination limit #{page.length} offset #{page.begin} ]]>"));
	...
	public boolean sqlMapSelectByExampleWithoutBLOBsElementGenerated(
		...
		pageStart.addAttribute(new Attribute("refid", "PostgreSQLDialectPrefix"));
